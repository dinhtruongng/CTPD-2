...
# model
BASE_PATH="/home/ngannt61/PrefKD/baseline/DSKD-main"
CKPT_TYPE="llama"
CKPT_NAME="llama8B"
CKPT_PATH="/mnt/nfs-nlp/models/Meta-Llama-3.2-1B/"
# we use qwen-1.8b as the teacher with the different vocabulary from gpt2
TEACHER_MODEL_TYPE="qwen"
TEACHER_MODEL_NAME="Qwen2.5-7B"
TEACHER_MODEL_PATH="/mnt/nfs-nlp/models/Qwen-2.5-7B/sft/v6/Qwen14B"
# data
DATA_DIR="${BASE_PATH}/data/ultra-feedback/"
# task
TASK="multi_level_ot"
# hp
BATCH_SIZE=4
